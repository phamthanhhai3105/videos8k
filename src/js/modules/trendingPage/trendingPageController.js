        ...
        function($rootScope, $scope, $state, searchService, $stateParams) {
            $scope.init = function() {
                ...
                switch ($stateParams.category) {
                    case 'music':
						document.title = 'Videos8k - Trending Music Videos';
                        $scope.title = 'Trending Music Videos';
                        categoryId = 10;
                        break;
                    case 'sports':
						document.title = 'Videos8k - Trending Sports Videos';
                        $scope.title = 'Trending in Sports';
                        categoryId = 17;
                        break;
                    case 'technology':
						document.title = 'Videos8k - Trending Technology Videos';
                        $scope.title = 'Trending Technology Videos';
                        categoryId = 28;
                        break;
                    case 'movies':
						document.title = 'Videos8k - Trending Movies Videos';
                        $scope.title = 'Trending Movies Videos';
                        categoryId = 1;
                        break;
                    case 'comedy':
						document.title = 'Videos8k - Trending Comedy Videos';
                        $scope.title = 'Trending Comedy Video';
                        categoryId = 23;
                        break;
                    case 'People & Blogs':
						document.title = 'Videos8k - Trending People & Blogs Videos';
                        $scope.title = 'Trending People & Blogs Videos';
                        categoryId = 15;
                        break;
                    default:
						document.title = 'Videos8k - Trending Videos';
